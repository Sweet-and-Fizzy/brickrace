  ...
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div v-else-if="currentHeat" class="space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="text-center">
              <h3 class="text-xl font-semibold text-gray-700 dark:text-gray-300 mb-4">Track 1</h3>
              <div v-if="currentHeat.racers[0]" class="space-y-3">
                ...
                <div
                  v-else
                  class="w-32 h-32 bg-gray-200 dark:bg-gray-700 rounded-lg mx-auto flex items-center justify-center"
                >
            ...
            <!-- Track 2 -->
            <div class="text-center">
              <h3 class="text-xl font-semibold text-gray-700 dark:text-gray-300 mb-4">Track 2</h3>
        ...
        >
          <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">Up Next</h3>
      ...
      >
        ...
        <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-2">No Active Heat</h3>
      ...
      <div
        v-else-if="!loading && !currentRace"
        class="bg-yellow-50 dark:bg-yellow-900/20 p-8 rounded-lg text-center"
      >
        ...
        <p class="text-yellow-700 dark:text-yellow-300">There is no active race at this time.</p>
      </div>
    </div>
  </div>
</template>
