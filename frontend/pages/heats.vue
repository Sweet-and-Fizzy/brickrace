<template>
  <div class="min-h-screen bg-gray-50">
    <PageHeader title="Current Heats" description="Live qualifier heat progress" />
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div v-else-if="currentHeat" class="space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-lg p-8">
          <div class="text-center mb-6">
            <h2 class="text-3xl font-bold text-black">Heat #{{ currentHeat.heat_number }}</h2>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="text-center">
              <h3 class="text-xl font-semibold text-gray-700 mb-4">Track 1</h3>
              <div v-if="currentHeat.racers[0]" class="space-y-3">
                ...
                <p class="text-lg text-gray-600">Racer #{{ currentHeat.racers[0].racer_number }}</p>
              </div>
            </div>
            ...
            <!-- Track 2 -->
            <div class="text-center">
              <h3 class="text-xl font-semibold text-gray-700 mb-4">Track 2</h3>
              <div v-if="currentHeat.racers[1]" class="space-y-3">
                ...
                <p class="text-lg text-gray-600">Racer #{{ currentHeat.racers[1].racer_number }}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <!-- Upcoming Heats -->
        <div v-if="upcomingHeats.length > 0" class="bg-white rounded-xl shadow-lg p-6">
          <h3 class="text-2xl font-bold text-black mb-4">Up Next</h3>
          ...
          <div class="space-y-4">
            ...
            >
              <h4 class="font-semibold text-black mb-2">
                ...
                <span v-if="index === 0" class="ml-2 text-sm text-blue-600"> (Next) </span>
              </h4>
      ...
      >
        ...
        <h3 class="text-xl font-semibold text-black mb-2">No Active Heat</h3>
        <p class="text-gray-600">Heats will begin soon. Check back for live updates!</p>
      </div>

      <!-- No Active Race -->
      <div v-else-if="!loading && !currentRace" class="bg-yellow-50/20 p-8 rounded-lg text-center">
        <i class="pi pi-exclamation-triangle text-4xl text-yellow-600 mb-4" />
        <h3 class="text-xl font-semibold text-yellow-800 mb-2">No Active Race</h3>
        <p class="text-yellow-700">There is no active race at this time.</p>
      </div>
    </div>
  </div>
</template>
