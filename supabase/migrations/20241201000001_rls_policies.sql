...
DROP POLICY IF EXISTS "Users can delete their own racers" ON public.racers;
...
DROP POLICY IF EXISTS "Anyone can view qualifiers" ON public.qualifiers;
...
DROP POLICY IF EXISTS "Anyone can view brackets" ON public.brackets;
